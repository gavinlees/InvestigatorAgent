...
- ✅ **reviews/security**: Must be APPROVED with LOW risk findings only.
- ✅ **reviews/uat**: Must be PASSED with no critical feedback.
- ✅ **reviews/stakeholders**: All required approvals (PM, Lead, etc.) must be obtained.
...
- Cite specific findings or blocker comments from manual reviews.
...
4. Use get_analysis() to retrieve ALL relevant metrics and manual reviews for the current and target stage.
